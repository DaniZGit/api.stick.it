...
// Represents data sent to templates
...
func (m Mailer) Send(recipient, templateFile string, data interface{}) error {
	...
	templateData := structuredData(data)
	...
	err = tmpl.ExecuteTemplate(plainBody, "plainBody", templateData)
	if err != nil {
		return err
	}
	...
	func structuredData(data interface{}) TemplateData {
		// add server config fields
		return TemplateData{
			Data: data,
			App: TemplateConfig{
